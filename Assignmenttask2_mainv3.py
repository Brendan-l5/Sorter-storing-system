...
# ====================================================== TEACH PENDANT FUNCTION ==========================================================
    ...
    def create_teach_pendant(self, robot, robot_name):
        ...
        ax_joint.axis('off')
        ax_joint.text(0.5, 0.95, f'{robot_name} - Joint Control', ha='center', fontsize=12, fontweight='bold')
        ...
        ax_cart.axis('off')
        ax_cart.text(0.5, 0.95, f'{robot_name} - Cartesian Control', ha='center', fontsize=12, fontweight='bold')
        ...
        reset_btn = Button(reset_ax, 'Reset', color='lightblue', hovercolor='skyblue')
        ...
        close_btn = Button(close_ax, 'Close', color='lightcoral', hovercolor='red')
